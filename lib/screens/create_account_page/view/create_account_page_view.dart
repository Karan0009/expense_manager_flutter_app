...
import 'package:expense_manager/screens/create_account_page/controller/create_account_page_viewmodel.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:google_fonts/google_fonts.dart';

class CreateAccountPageView extends ConsumerWidget {
  static const String routePath = '/create-account';
  const CreateAccountPageView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final loginState = ref.watch(createAccountPageViewModelProvider);
    final viewModel = ref.read(createAccountPageViewModelProvider.notifier);
